...
const TodoList = ({todos, onEditTodo, onDeleteTodo, onAddDealine} : Props) => {
    ...
    return (
        ...
        <tbody className="bg-white divide-y divide-gray-200">
            {!todos.length
              ...
              : todos.map(todo => !todo.hide && <TodoItem key={todo.id} todo={todo} onEditTodo={onEditTodo} onDeleteTodo={onDeleteTodo} onAddDealine={onAddDealine}/>)}
        </tbody>
      </table>
    )
}
